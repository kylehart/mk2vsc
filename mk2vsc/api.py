...
GROUPS: List[Tuple[str, List[str]]] = [
    ...
    ("Inverter / AC input", ["inverter_output_V", "ac1_input_limit_A", "ac2_input_limit_A", "dc_low_shutdown_V",
                             "dc_low_restart_offset_V"]),
    ("Battery monitor", ["battery_capacity_Ah", "soc_at_bulk_end_pct"]),
    ("Virtual Switch (ignore AC input)", ["vs_dont_ignore_load_above_A", "vs_load_above_for", "vs_ignore_load_below_A",
                                          "vs_load_below_for", "vs_ignore_ac_below_V", "vs_udc_below_for",
                                          "vs_dont_ignore_soc_below_pct", "vs_accept_battery_above_V", "vs_udc_above_for",
