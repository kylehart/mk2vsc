...
GROUPS: List[Tuple[str, List[str]]] = [
    ...
    ("Virtual Switch (ignore AC input)", ["vs_ignore_ac_below_V", "vs_accept_battery_above_V", "vs_param50", "vs_param51",
                                          "vs_param52", "vs_param53", "vs_param55", "vs_param56", "vs_param57", "vs_param59"]),
