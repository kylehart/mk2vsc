...
451 tests, under a second.

## The corpus and its limits

84 unique files, 214 inverter blocks, 8 inverters in 4 two-inverter split-phase systems, one
...
|---|---|---|
| Section grammar and checksum | proven | 107/107 files (84 unique plus duplicates in the archive), every section; four live uploads accepted; byte-exact round trip on every fixture |
...
| Qualifier | proven against its motivating incident | catches the 2026-08-14 rollback file and the 2026-08-21 split write |
