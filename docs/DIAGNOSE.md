...
| E2 | Assistant on some inverters but not others | records on some blocks, none on others | BLOCKS | device-confirmed (System C, 2026-07-17 to 07-20) | 10 | as E1; names the inverter that lacks it. Conditional on `ess_intended` |
