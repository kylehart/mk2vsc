...
2. Dialogs you will see:
   ...
   - `mk2vsc-36`, `mk2vsc-47`, `mk2vsc-49`: the device rejected the file before writing anything.
     See docs/ERRORS.md. mk2vsc-36 on a settings-only upload has, in our record, always followed an
     archived file whose grid-code words differed from the device's; download fresh and rebuild.
