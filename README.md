...
| Field table (192 entries) | Partial | every ID carries VEConfigure's identifier; 89 settings and bits placed on VEConfigure's tabs (`mk2vsc fields --by-tab`); decode confidence 4 CONFIRMED, 68 HIGH, 9 MEDIUM, 12 LOW, 99 UNKNOWN (reserved and grid-code slots) |
